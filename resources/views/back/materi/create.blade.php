                ...
                <div class="card full-height">
                    <div class="card-header">
                        <div class="card-head-row">
                            <div class="card-title">Menambahkan Data Materi</div>
                        ...
                        <div class="card-body-row">
                            <form action="{{ route('materi.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title" placeholder="Masukan Judul Materi">
                                </div> 
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select type="text" class="form-control" id="playlist_id" name="playlist_id" placeholder="Masukan Playlist">
                                ...
                                <div class="form-group">
                                    ...
                                    <select type="file" class="form-control" id="is_active" name="is_active">
